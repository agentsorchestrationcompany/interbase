...
Generates UPCOMING_CHANGELOG.md by running the interbase changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for interbase run (default: low)
      --quiet            Suppress interbase command output unless it fails
