...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Interbase system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Interbase system.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Interbase configuration settings and preferences.
   */
   ...
   *
   * Update global Interbase configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Interbase server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Interbase system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Interbase instances, releasing all resources.
   */
   ...
   * Upgrade interbase
   *
   * Upgrade interbase to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Interbase configuration settings and preferences.
   */
   ...
   *
   * Update Interbase configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Console extends HeyApiClient {
   ...
   *
   * Get Console provider metadata for the current instance.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Interbase instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Interbase system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Interbase.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Interbase is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Interbase.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Interbase sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Interbase session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
