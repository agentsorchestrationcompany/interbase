...
import { ensureProcessMetadata } from "../util/interbase-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    serviceName: "interbase",
    serviceVersion: InstallationVersion,
    attributes: {
      ...attributes,
      "deployment.environment.name": InstallationChannel,
      "interbase.client": Flag.INTERBASE_CLIENT,
      "interbase.process_role": processMetadata.processRole,
      "interbase.run_id": processMetadata.runID,
