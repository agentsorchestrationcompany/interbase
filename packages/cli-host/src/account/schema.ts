...
export const LoginState = Schema.String.pipe(Schema.brand("LoginState"))
export type LoginState = Schema.Schema.Type<typeof LoginState>

export const CodeVerifier = Schema.String.pipe(Schema.brand("CodeVerifier"))
...
export type AccountError = AccountServiceError | AccountTransportError
