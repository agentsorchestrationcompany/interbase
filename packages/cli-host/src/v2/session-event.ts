...
const Error = Schema.Struct({
  ...
  usageLimited: Schema.Boolean.pipe(Schema.optional),
})
...
export namespace Compaction {
  export const Phase = Schema.Literals(["manual", "preTurn", "midTurn"])
  export const Reason = Schema.Literals(["contextLimit", "modelDownshift", "userRequested", "overflow"])
