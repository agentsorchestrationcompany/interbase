...
export class Service extends Context.Service<Service, Interface>()("@interbase/Snapshot") {}
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Snapshot.state")(function* (ctx) {
        const state = {
          ...
          gitdir: path.join(interbaseRuntimeContext.paths.data, "snapshot", ctx.project.id, Hash.fast(ctx.worktree)),
          vcs: ctx.project.vcs,
        }
