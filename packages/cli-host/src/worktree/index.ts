...
export class Service extends Context.Service<Service, Interface>()("@interbase/Worktree") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const makeWorktreeInfo = Effect.fn("Worktree.makeWorktreeInfo")(function* (name?: string) {
      ...
      const root = pathSvc.join(interbaseRuntimeContext.paths.data, "worktree", ctx.project.id)
