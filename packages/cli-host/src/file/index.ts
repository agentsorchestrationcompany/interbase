...
export class Service extends Context.Service<Service, Interface>()("@interbase/File") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const scan = Effect.fn("File.scan")(function* () {
      ...
      const isGlobalHome = ctx.directory === interbaseRuntimeContext.paths.home && ctx.project.id === "global"
