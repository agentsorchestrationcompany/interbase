...
const KeybindsSchema = Schema.Struct({
  leader: keybind("ctrl", "Leader key for keybind combinations"),
  ...
  sidebar_toggle: keybind("ctrl+s", "Toggle sidebar"),
  ...
  messages_copy: keybind("ctrl+o,<leader>y", "Copy message"),
  ...
  agent_cycle: keybind(INTERBASE_KEYBIND_DEFAULTS.agent_cycle, "Next agent"),
  agent_cycle_reverse: keybind(INTERBASE_KEYBIND_DEFAULTS.agent_cycle_reverse, "Previous agent"),
  variant_cycle: keybind("ctrl+t", "Cycle model variants"),
  variant_list: keybind("none", "List model variants"),
  input_clear: keybind("ctrl+c", "Clear input field"),
  input_paste: keybind("ctrl+v", "Paste from clipboard"),
  input_submit: keybind(INTERBASE_KEYBIND_DEFAULTS.input_submit, "Submit input"),
