...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/agentsorchestrationcompany/interbase/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("interbase-version", InstallationVersion)
