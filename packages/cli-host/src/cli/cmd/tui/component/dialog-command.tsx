...
export type Slash = {
  name: string
  aliases?: string[]
  argumentAliases?: { name: string; arguments: string }[]
}
    ...
    slashes() {
      return visibleOptions().flatMap((option) => {
        ...
        return {
          ...
          argumentAliases: slash.argumentAliases?.map((alias) => ({
            display: "/" + alias.name,
            arguments: alias.arguments,
          })),
          onSelect: option.onSelect ? () => result.trigger(option.value) : undefined,
        }
      })
    },
