...
export const runDebugInfoEffect = Effect.fn("Cli.debug.info")(function* () {
  ...
  console.log(`interbase version: ${InstallationVersion}`)
  console.log(`os: ${os.type()} ${os.release()} ${os.arch()}`)
  console.log(`terminal: ${terminal || "unknown"}`)
  console.log("plugins:")
  if (Flag.INTERBASE_PURE) {
...
const PathsCommand = cmd({
  ...
  handler() {
    for (const [key, value] of Object.entries(interbaseRuntimeContext.paths)) {
