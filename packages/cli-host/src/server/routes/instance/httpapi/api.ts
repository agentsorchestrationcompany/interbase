...
export const RootHttpApi = HttpApi.make("interbase-root").addHttpApi(ControlApi).addHttpApi(GlobalApi)

export const InstanceHttpApi = HttpApi.make("interbase-instance")
...
export const OpenCodeHttpApi = HttpApi.make("interbase")
