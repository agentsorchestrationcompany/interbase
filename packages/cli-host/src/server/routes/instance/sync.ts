...
export function createSyncRoutes(runtime: AppRuntimeLike = AppRuntime) {
  return new Hono()
    .post(
      "/replay",
      describeRoute({
      ...
      async (c) => {
        ...
        await runtime.runPromise(SyncEvent.use.replayAll(events))
...
export const SyncRoutes = lazy(() => createSyncRoutes())
