...
export function createProjectRoutes(runtime: AppRuntimeLike = AppRuntime) {
  ...
  return new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of projects that have been opened with Interbase.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the currently active project that Interbase is working with.",
...
export const ProjectRoutes = lazy(() => createProjectRoutes())
