...
export function createSessionRoutes(runtime: AppRuntimeLike = AppRuntime) {
  ...
  return new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Interbase sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Interbase session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Interbase session for interacting with AI assistants and managing conversations.",
      ...
      async (c) =>
        jsonRequest("SessionRoutes.update", c, function* () {
          ...
          if (updates.model !== undefined) {
            ...
            const model = yield* provider.getModel(updates.model.providerID, updates.model.id)
...
export const SessionRoutes = lazy(() => createSessionRoutes())
