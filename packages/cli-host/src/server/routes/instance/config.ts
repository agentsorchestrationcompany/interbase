...
export function createConfigRoutes(runtime: AppRuntimeLike = AppRuntime) {
  ...
  return new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current Interbase configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update Interbase configuration settings and preferences.",
...
export const ConfigRoutes = lazy(() => createConfigRoutes())
