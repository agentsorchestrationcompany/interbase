...
import { createJsonRequest } from "./trace"

export function createPermissionRoutes(runtime: AppRuntimeLike = AppRuntime) {
...
export const PermissionRoutes = lazy(() => createPermissionRoutes())
