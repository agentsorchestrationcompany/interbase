...
export class Service extends Context.Service<Service, Interface>()("@interbase/SessionProcessor") {}
      ...
      const handleEvent = Effect.fnUntraced(function* (value: StreamEvent) {
        switch (value.type) {
          ...
          case "reasoning-end":
            ...
            // eslint-disable-next-line no-self-assign -- reactivity trigger
        ...
        if (!ctx.assistantMessage.summary) {
          ...
          EventV2.run(SessionEvent.Step.Failed.Sync, {
            ...
            error: {
              ...
              usageLimited: MessageV2.isUsageLimitError(error) || undefined,
            },
            timestamp: DateTime.makeUnsafe(Date.now()),
          })
        }
