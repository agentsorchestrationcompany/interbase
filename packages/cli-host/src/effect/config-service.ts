 ...
 *   "@interbase/ServerAuthConfig",
 *   {
 *     password: Config.string("INTERBASE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("INTERBASE_SERVER_USERNAME").pipe(Config.withDefault("interbase")),
 *   },
 * ) {}
 *
...
export const Service =
  ...
  <const Id extends string, const Fields extends ConfigMap>(id: Id, fields: Fields) => {
      ...
      static get defaultLayer() {
        return Layer.effect(
          ...
          Config.all(fields)
            .asEffect()
            .pipe(
              // eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion -- Config.all preserves the field shape, but its conditional return type also supports iterable inputs.
    ...
    // eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion -- The generated class carries typed static helpers.
