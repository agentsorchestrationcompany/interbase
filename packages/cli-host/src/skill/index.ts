...
const INTERBASE_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  if (!Flag.INTERBASE_DISABLE_EXTERNAL_SKILLS) {
    if (!Flag.INTERBASE_DISABLE_CLAUDE_CODE_SKILLS) externalDirs.push(CLAUDE_EXTERNAL_DIR)
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, INTERBASE_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@interbase/Skill") {}
