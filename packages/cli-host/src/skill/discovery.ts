...
export class Service extends Context.Service<Service, Interface>()("@interbase/SkillDiscovery") {}
...
export const layer: Layer.Layer<Service, never, AppFileSystem.Service | Path.Path | HttpClient.HttpClient> =
  Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const cache = path.join(interbaseRuntimeContext.paths.cache, "skills")
