...
const filepath = path.join(interbaseRuntimeContext.paths.data, "mcp-auth.json")
...
export class Service extends Context.Service<Service, Interface>()("@interbase/McpAuth") {}
