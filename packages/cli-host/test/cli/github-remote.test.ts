...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/interbase.git")).toEqual({ owner: "sst", repo: "interbase" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/interbase")).toEqual({ owner: "sst", repo: "interbase" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/interbase.git")).toEqual({ owner: "sst", repo: "interbase" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/interbase")).toEqual({ owner: "sst", repo: "interbase" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/interbase.git")).toEqual({ owner: "sst", repo: "interbase" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/interbase")).toEqual({ owner: "sst", repo: "interbase" })
})
