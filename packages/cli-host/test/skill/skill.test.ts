...
const withHome = <A, E, R>(home: string, self: Effect.Effect<A, E, R>) =>
  Effect.acquireUseRelease(
    Effect.sync(() => {
      const prev = process.env.INTERBASE_TEST_HOME
    ...
    (prev) =>
      Effect.sync(() => {
        process.env.INTERBASE_TEST_HOME = prev
      }),
  )

describe("skill", () => {
  it.live("discovers skills from .interbase/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".interbase", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".interbase", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".interbase", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .interbase/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".interbase", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".interbase", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".interbase", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
...
`,
              ...
              Bun.write(
                path.join(dir, ".interbase", "skill", "agent-skill", "SKILL.md"),
                `---
name: interbase-skill
description: A skill in the .interbase/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".interbase", "skills", "agent-skill", "SKILL.md"),
                `---
name: interbase-skill
description: A skill in the .interbase/skills directory.
---
