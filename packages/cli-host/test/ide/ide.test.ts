...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders INTERBASE_CALLER", () => {
    process.env["INTERBASE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode INTERBASE_CALLER", () => {
    process.env["INTERBASE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown INTERBASE_CALLER", () => {
    process.env["INTERBASE_CALLER"] = "unknown"
