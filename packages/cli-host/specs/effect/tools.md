...
Practical reference for the current tool-migration state in `packages/cli-host`.
...
Tool tests should use the existing Effect helpers in `packages/cli-host/test/lib/effect.ts`:
