...
- `src/effect/instance-ref.ts` provides `InstanceRef`
...
Current total: `56` files in `packages/cli-host/src`.
...
- move these to explicit Effect entrypoints that provide `InstanceRef`
...
- path: `<repo-root>/worktrees/instance-effect-shift`
